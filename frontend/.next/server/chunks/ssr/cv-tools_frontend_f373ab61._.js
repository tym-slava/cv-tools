...
function CommonDropzone() {
    const { getRootProps, getInputProps, open, acceptedFiles } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$react$2d$dropzone$2f$dist$2f$es$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useDropzone"])({
        // Disable click and keydown behavior
        noClick: true,
        noKeyboard: true
    });
    const files = acceptedFiles.map((file)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
            children: [
                file.path,
                " - ",
                file.size,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        type: "button",
                        onClick: open,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                        children: "Files"
                    }, void 0, false, {
                        fileName: "[project]/cv-tools/frontend/app/common-components/CommonDropzone/index.tsx",
                        lineNumber: 30,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                        children: files
                    }, void 0, false, {
                        fileName: "[project]/cv-tools/frontend/app/common-components/CommonDropzone/index.tsx",
                        lineNumber: 31,
...
const useCvBuilderStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        updatePersonalInfo: (data)=>set((state)=>({
                    cvData: {
                        ...state.cvData,
                        personalInformation: {
                            ...state.cvData.personalInformation,
                            ...data
                        }
                    }
                })),
        ...
        updateProfessionalSummary: (id, data)=>set((state)=>({
                    cvData: {
                        ...state.cvData,
                        professionalSummary: state.cvData.professionalSummary.map((item)=>item.id === id ? {
                                ...item,
                                ...data
                            } : item)
                    }
        ...
        deleteProfessionalSummary: (id)=>set((state)=>({
                    cvData: {
                        ...state.cvData,
                        professionalSummary: state.cvData.professionalSummary.filter((item)=>item.id !== id)
                    }
                })),
        ...
        updateWorkExperience: (id, data)=>set((state)=>({
                    cvData: {
                        ...state.cvData,
                        workExperience: state.cvData.workExperience.map((item)=>item.id === id ? {
                                ...item,
                                ...data
                            } : item)
                    }
        ...
        deleteWorkExperience: (id)=>set((state)=>({
                    cvData: {
                        ...state.cvData,
                        workExperience: state.cvData.workExperience.filter((item)=>item.id !== id)
                    }
                }))
    }));
}}),
...
function ProfessionalSummary() {
    const { cvData, addProfessionalSummary, updateProfessionalSummary, deleteProfessionalSummary } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$store$2f$useCvBuilderStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCvBuilderStore"])();
    ...
    const handleUpdateSummary = (id, field, value)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            cvData.professionalSummary.map((summary)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$app$2f$common$2d$components$2f$CommonInfoDropdownItem$2f$index$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    title: summary.title || "New Entry",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f40$heroui$2f$input$2f$dist$2f$chunk$2d$HJTJQZF3$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__input_default__as__Input$3e$__["Input"], {
                            type: "text",
                            placeholder: "Enter your professional summary title",
                            value: summary.title,
                            onValueChange: (value)=>handleUpdateSummary(summary.id, "title", value),
                            className: "mb-4"
                        }, void 0, false, {
                            fileName: "[project]/cv-tools/frontend/app/cv-builder/ProfessionalSummary/index.tsx",
                            lineNumber: 39,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$cv$2d$tools$2f$frontend$2f$app$2f$common$2d$components$2f$CommonTextArea$2f$index$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                onChange: (value)=>handleUpdateSummary(summary.id, "description", value),
                                placeholder: "Enter your professional summary description"
                            }, void 0, false, {
                                fileName: "[project]/cv-tools/frontend/app/cv-builder/ProfessionalSummary/index.tsx",
                                lineNumber: 48,
                                columnNumber: 13
...
//# sourceMappingURL=cv-tools_frontend_f373ab61._.js.map